...
export class AdminJobsService {
    ...
    public getAllApplications(id: number): Observable<JobApplication[]> {
        return this.httpClient.get<JobApplication[]>(`${this.appConfig.apiUrl}/admin/careers/jobDetails/${id}/applications`);
    }
}

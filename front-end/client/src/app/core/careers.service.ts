...
export class CareersService {
    ...
    public createNewApplication(userApplication: any, jobId: number): Observable<Job> {
    ...
    public downloadFile(url: string): Observable<object> {
        ...
        return this.httpClient.post(`${this.appConfig.apiUrl}/careers/download`, { fileName: file }, {
            responseType: 'blob',
            observe: 'response',
        });
    }
